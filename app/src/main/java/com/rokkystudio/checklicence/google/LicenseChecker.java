package com.rokkystudio.checklicence.google;
...
public class LicenseChecker implements ServiceConnection
{
     ...
     */
    public LicenseChecker(@NonNull Context context, Policy policy, String encodedPublicKey) {
        mContext = context;
        mPolicy = policy;
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                ...
                try {
                    ...
                    boolean bindResult = mContext.bindService(intent,this, Context.BIND_AUTO_CREATE);
                ...
                public void run()
                {
                    ...
                    if (DEBUG_LICENSE_ERROR)
                    {
                        ...
                        if (logResponse) {
                            ...
                            Log.d(TAG, "Time: " + DateFormat.format("dd MMM yyyy HH:mm:ss", date));
    ...
    private static String getVersionCode(@NonNull Context context, String packageName)
    {
        String version = "";
        try {
            ...
            if (Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.P) {
                ...
                version = String.valueOf(manager.getPackageInfo(packageName, 0).getLongVersionCode());
            }
